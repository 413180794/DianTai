...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 781, 391))
        ...
        self.start_voice_button = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.start_voice_button.setObjectName("start_voice_button")
        self.horizontalLayout.addWidget(self.start_voice_button)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.send_file_button = QtWidgets.QPushButton(self.horizontalLayoutWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.start_voice_button.setText(_translate("MainWindow", "话音交互"))
        self.send_file_button.setText(_translate("MainWindow", "数据交互"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Property_tab), _translate("MainWindow", "属性配置"))
